...
#define LOW  0
//#ifndef PG6
    //#define PG6 6  // Pin 45 on the Arduino Mega is PG6 (Port G, Pin 6)
//#endif
// Define control macros for each pin (40 to 45) on Arduino Mega
#define CUSTOM_PIN_40_ON  (PORTG |= (1 << PG1))  // Set Pin 40 HIGH
#define CUSTOM_PIN_40_OFF (PORTG &= ~(1 << PG1)) // Set Pin 40 LOW
#define CUSTOM_PIN_41_ON  (PORTG |= (1 << PG0))  // Set Pin 41 HIGH
#define CUSTOM_PIN_41_OFF (PORTG &= ~(1 << PG0)) // Set Pin 41 LOW
#define CUSTOM_PIN_42_ON  (PORTL |= (1 << PL7))  // Set Pin 42 HIGH
#define CUSTOM_PIN_42_OFF (PORTL &= ~(1 << PL7)) // Set Pin 42 LOW
#define CUSTOM_PIN_43_ON  (PORTL |= (1 << PL6))  // Set Pin 43 HIGH
#define CUSTOM_PIN_43_OFF (PORTL &= ~(1 << PL6)) // Set Pin 43 LOW
#define CUSTOM_PIN_44_ON  (PORTL |= (1 << PL5))  // Set Pin 44 HIGH
#define CUSTOM_PIN_44_OFF (PORTL &= ~(1 << PL5)) // Set Pin 44 LOW
#define CUSTOM_PIN_45_ON  (PORTL |= (1 << PL4))  // Set Pin 45 HIGH
#define CUSTOM_PIN_45_OFF (PORTL &= ~(1 << PL4)) // Set Pin 45 LOW
/* ---------------------------------------------------------------------------------------
